...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Vercel-black?style=for-the-badge&logo=vercel)](https://deep-learning-seg-class-ai.vercel.app/)
...
![Project Architecture](./figures/graphical_abstract.png)
...
|-----------|---------|
| Image size | 224 × 224 |
| Normalization | ToTensor() → [0, 1]; mask binarized at 0.5 |
...
| Random seeds | Not fixed (single-run results) |
| Gradient clipping | Not applied |
| LR scheduling / EMA | Not applied |
